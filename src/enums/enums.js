...
export default {
  ...
  postponeReason: [
    { value: "1", label: "正在研究调离公安机关或者辞职、辞退的"},
    { value: "2", label: "因涉嫌违法违纪正在接受审查、尚未作出结论的"},
    { value: "3", label: "非公派离职学习期限超过一年的"},
    { value: "9", label: "因其他原因需暂缓的"},
  ],
  politicalStatus: [
    { value: "1", label: "中共党员"},
    { value: "2", label: "预备党员"},
  ...
  identificationOfAssistantCadres: [
    { value: "1", label: "部级协管干部"},
    { value: "2", label: "省级协管干部"},
    { value: "3", label: "市级协管干部"},
  ],
  managementCategory: [
    { value: "1", label: "中央管理干部"},
    { value: "2", label: "省级党委管理干部"},
    { value: "3", label: "市级党委管理干部"},
    { value: "4", label: "县级党委管理干部"},
    { value: "9", label: "其他"},
  ],
  status: [{
    value: "1",
    ...
    children: [
      { value: "101", label: "见习"},
      { value: "102", label: "在职领导"},
      { value: "103", label: "在职非领导"},
      { value: "104", label: "离岗休养"},
      { value: "109", label: "聘用"},
      { value: "199", label: "其他在职人员"},
    ]
  },{
    value: "2",
    label: "离职",
    ...
    children: [
      ...
      { value: "303", label: "辞退"},
      { value: "304", label: "开除"},
      { value: "305", label: "取消录用"},
    ]
  },{
    value: "4",
    label: "已去世",
    children: [
      { value: "401", label: "因公牺牲"},
      { value: "402", label: "在职病故"},
      { value: "403", label: "意外死亡"},
      { value: "404", label: "离退去世"},
    ]
  },{
    value: "900",
    label: "其他人员"
  ...
  personnelType: [{
    ...
    label: "综合管理类公务员",
    children: [
      { value: "11", label: "综合管理警官"},
      { value: "12", label: "综合管理警员"},
      { value: "19", label: "其他综合管理人员"},
    ]
  },{
    value: "2",
    label: "专业技术类公务员",
    children: [
      { value: "21", label: "警务技术警官"},
      { value: "22", label: "警务技术警员"}
    ]
  },{
    value: "3",
    label: "行政执法类公务员",
    children: [
      { value: "31", label: "执法勤务警官"},
      { value: "32", label: "执法勤务警员"},
    ]
  },{
    value: "50",
    label: "参照管理的机关工作人员",
  ...
  identity: [{
    ...
    label: "工勤人员",
    children: [
      { value: "31", label: "固定制工人"},
      { value: "32", label: "合同制工人"},
    ]
  },{
    value: "4",
    label: "文职人员",
  ...
  healthCondition: [{
    ...
    label: "健康",
    children: [
      { value: "10", label: "健康或良好"},
    ]
  },{
    value: "2",
    label: "一般",
    children: [
      { value: "20", label: "一般或较弱"},
    ]
  },{
    value: "3",
    label: "有病",
    children: [
      ...
      { value: "31", label: "心血管病"},
      { value: "32", label: "脑血管病"},
      { value: "33", label: "慢性呼吸系统病"},
      { value: "34", label: "慢性消化系统病"},
      { value: "35", label: "慢性肾炎"},
      { value: "36", label: "结核病"},
      { value: "37", label: "糖尿病"},
      { value: "38", label: "神经或精神疾病"},
      { value: "39", label: "其它慢性病"},
    ]
  },{
    value: "4",
    label: "有生理缺陷",
    children: [
      { value: "40", label: "有生理缺陷"},
      { value: "41", label: "聋哑"},
      { value: "42", label: "盲人"},
      { value: "43", label: "高度近视"},
      { value: "44", label: "其它缺陷"},
    ...
    children: [
      ...
      { value: "51", label: "特等伤残"},
      { value: "52", label: "一等伤残"},
      { value: "53", label: "二等甲级伤残"},
      { value: "54", label: "二等乙级伤残"},
      { value: "55", label: "三等甲级伤残"},
      { value: "56", label: "三等乙级伤残"},
      { value: "57", label: "其它伤残"}
    ]
  }
  ],
  departmentAndPoliceTypeAndStaffPosition: [{
    ...
    label: "一级公安机关及派出机构",
    children: [
      { value: "1001", label: "公安部"},
      { value: "1003", label: "公安厅"},
      { value: "1005", label: "直辖市公安局"},
      { value: "1007", label: "副省级市公安局"},
      { value: "1009", label: "地级市公安局"},
      { value: "1011", label: "县（市）公安局"},
      { value: "1013", label: "分局"},
      { value: "1015", label: "派出所"},
    ]
  },{
    value: "20",
    label: "部门",
    children: [
      {
        ...
        label: "纪检、监察、督察、审计",
        children: [
          { value: "200101", label: "纪检监察"},
          { value: "200102", label: "督察"},
          { value: "200103", label: "审计"},
        ]
      },
      {
        value: "2002",
        label: "办公室",
        children: [
          { value: "200201", label: "指挥中心"},
          { value: "200202", label: "调研"},
          { value: "200203", label: "机要"},
          { value: "200204", label: "统计"},
          { value: "200205", label: "档案"},
          { value: "200206", label: "信访"},
          { value: "200207", label: "情报信息"},
          { value: "200208", label: "其他"}
        ]
      },
      {
        value: "2003",
        label: "政工",
        children: [
          { value: "200301", label: "人事训练"},
          { value: "200302", label: "宣传"},
        ]
      },
      {
        value: "2004",
        label: "国内安全保卫",
        children: [
          { value: "200401", label: "文保"},
          { value: "200402", label: "其他"},
        ]
      },
      {
        value: "2005",
      ...
      },
      {
        ...
        label: "治安",
        children: [
          { value: "200601", label: "治安管理"},
          { value: "200602", label: "经保"},
          { value: "200603", label: "户政"},
          { value: "200604", label: "治安队"},
          { value: "200605", label: "公安特警队"},
          { value: "200606", label: "巡警队"},
          { value: "200607", label: "水警"},
          {
            value: "200608",
            label: "治安检查站",
            children: [
              { value: "20060801", label: "一级公安检查站"},
              { value: "20060803", label: "二级公安检查站"},
            ]
          },
          { value: "200609", label: "派出所"}
        ]
      },
      {
        value: "2007",
        label: "刑侦",
        children: [
          { value: "200701", label: "刑侦管理"},
          { value: "200702", label: "刑警队"},
          { value: "200703", label: "刑事技术"},
          { value: "200704", label: "警犬技术"},
        ]
      },
      {
        value: "2008",
        label: "出入境管理",
        children: [
          { value: "200801", label: "边检站"},
          { value: "200802", label: "其他"},
        ]
      },
      {
        value: "2009",
      ...
      },
      {
        ...
        label: "监所管理",
        children: [
          { value: "201101", label: "监所管理"},
          { value: "201102", label: "看守所"},
          { value: "201103", label: "拘留所"},
          { value: "201104", label: "收容教育所"},
          { value: "201105", label: "强制戒毒所"},
          { value: "201106", label: "安康医院"},
        ]
      },
      {
        value: "2012",
        label: "交通",
        children: [
          { value: "201201", label: "道路执勤执法"},
          { value: "201202", label: "交通事故处理"},
          { value: "201203", label: "车辆和驾驶人管理"},
          { value: "201204", label: "其他"},
        ]
      },
      {
        value: "2013",
      ...
      },
      {
        ...
        label: "禁毒",
        children: [
          { value: "201601", label: "禁毒管理"},
          { value: "201602", label: "缉毒队"},
        ]
      },
      {
        value: "2017",
        label: "科技信息",
        children: [
          { value: "201701", label: "科技管理"},
          { value: "201702", label: "信息通信"},
        ]
      },
      {
        value: "2018",
  ...
  place: [
    ...
    },
    {
      ...
      children: [
        ...
        {value: "500233", label: "忠　县"},
        {value: "500234", label: "开　县"},
    ...
    {value: "420000", label: "湖北省",
      children: [
        ...
        {value: "420600", label: "襄樊市", children: [
    ...
    {value: "460000", label: "海南省",
      children: [
        ...
        {value: "469000", label: "省直辖县级行政区划", children: [
          ...
          {value: "469031", label: "西沙群岛"
          },
          {value: "469032", label: "南沙群岛"
          },
          {value: "469033", label: "中沙群岛的岛礁及其海域"
          }
        ]
        }
      ]
    ...
    {value: "520000", label: "贵州省",
      children: [
        ...
        {value: "522200", label: "铜仁地区", children: [
        ...
        {value: "522400", label: "毕节地区", children: [
    ...
    {value: "540000", label: "西藏自治区",
      children: [
        ...
        {value: "542200", label: "山南地区", children: [
        ...
        {value: "542300", label: "日喀则地区", children: [
    ...
    {value: "630000", label: "青海省",
      children: [
        ...
        {value: "632100", label: "海东地区", children: [
    ...
    {value: "650000", label: "新疆维吾尔自治区",
      children: [
        ...
        {value: "652200", label: "哈密地区", children: [
