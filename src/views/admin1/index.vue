  ...
  <div class="admin-container">
    <el-row :gutter="48" class="panel-group">
      <el-col :xs="48" :sm="24" :lg="24">
        <el-card class="title-card">
          <div slot="header" class="clearfix">
            <el-row type="flex">
              <el-col span="24"
                ><div class="card-panel-text">设备管理——普通用户</div></el-col
              >
              <vue-xlsx-table @on-select-file="handleSelectedFile">
              导入本队设备分配</vue-xlsx-table
            >
            </el-row>
          </div>
        </el-card>
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="gotosearch1">
          <div class="card-panel-icon-wrapper icon-message">
            <svg-icon icon-class="message" class-name="card-panel-icon" />
          </div>
          <div class="card-panel-description">
            <div class="card-panel-text">查看设备分配情况</div>
          </div>
        </div>
      </el-col>
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="gotosearch4">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">手动回收分配设备</div>
          </div>
        </div>
      </el-col>
    </el-row>
