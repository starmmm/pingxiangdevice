      ...
      <el-col :xs="48" :sm="24" :lg="24">
        <el-card class="title-card">
          ...
          <div slot="header" class="clearfix">
            <el-row type="flex">
              <el-col span="24"><span>部门调整申请</span></el-col>
          ...
          >
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="目前所在部门" prop="oldDepartmentId" size="small">
                  <el-select v-model="inputForm.oldDepartmentId" disabled>
                    <el-option-group
              ...
              <el-col :span="8">
                <el-form-item label="调整所在部门" prop="newDepartmentId" size="small">
                  <el-select v-model="inputForm.newDepartmentId" placeholder="请选择">
                    <el-option-group
                      v-for="group in departmentoptions"
                      :key="group.label"
                      :label="group.label"
    ...
    <el-row :gutter="40" class="card-group">
      <el-col :xs="48" :sm="24" :lg="24">
        <el-card class="title-card">
          <div slot="header" class="clearfix">
            <el-row type="flex">
              <el-col span="24"><span>部门调整状态查询</span></el-col>
...
import {submitDepartmentApplication,getDepartmentApplicationList} from "../../apis/positionChange"
...
export default {
  ...
  data() {
    return {
      ...
      inputForm: {
        ...
        oldDepartmentId: parseInt(this.$route.query.oldDepartmentId),
        newDepartmentId: "",
      },
      getTableForm: {
        page: 1,
  ...
  mounted() {
    this.inputForm.oldDepartmentId = this.$route.query.oldDepartmentId ? parseInt(this.$route.query.oldDepartmentId) : ""
    this.getTableData();
  },
  methods: {
    goBack() {
    ...
    async submitForm() {
      const result = await submitDepartmentApplication(this.inputForm)
      if (result.code === 1) {
    ...
    // },
    async getTableData() {
      const result = await getDepartmentApplicationList(this.getTableForm)
      this.dataList = result.data
      this.tableDataSource = result.data.approveVoList
      for (const d of this.tableDataSource) {
        d.oldData = decode.departmentType[d.oldData]
        d.newData = decode.departmentType[d.newData]
